            ...
            <div class="cover-container">
				<div class="inner cover">
					<section class="container align-middle" id="select-form">
						<h1 class="head-text">Marble &amp; Granite</h1>
						<div class="stageOne">						
								...
								<div class="col-4 mt-5">
									<fieldset class="form-group">
										<label id="matCompBox">
											...
											<select class="inputControl2 form-control form-control-lg" id="matComp">
											</select>
										</label>
									</fieldset>
								</div>
...
<script type="text/javascript" src="js/functions-marbgran2.js"></script>
<script>
