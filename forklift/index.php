...
function checkOption(element) {
	...
	var changOpt = '<div id="changeBox" class="col-9"><div class="btn btn-primary w-100 h-100" onClick="changeElem(this)">Change</div></div>';
	$(element).parent().parent().prepend(changeOpt);
