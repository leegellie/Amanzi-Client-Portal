<?PHP
	...
	try {
		...
		$sql = "UPDATE user SET firstname=:firstname, lastname=:lastname, email=:email, phone=:phone, address=:address, guests=:guests, date=:date, source=:source WHERE record=:recordName";
