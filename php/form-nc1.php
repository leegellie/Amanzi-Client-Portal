<?php
//max_input_nesting_level = "70";
ini_set("max_input_nesting_level","70");
$version = "v1.3";
...
$Subject = "Client Portal - " . $_POST['form-name'] . " - " . $_POST['customer-name'] . " - " . $_POST['job-name'];
$file = $_FILES;
...
/*	$Body .= "<div style='display:inline-block;width:48%;min-height:30px;padding:5px;border-width:1px;border-style:solid;border-color:black;'><b>Material:</b> ".$_POST['material1']."</div>";
	...
	$Body .= "<div style='display:inline-block;width:48%;min-height:30px;padding:5px;border-width:1px;border-style:solid;border-color:black;'><b>Material:</b> ".$_POST['materialToUse1']."</div>";
...
/*	$Body .= "<div style='display:inline-block;width:48%;min-height:30px;padding:5px;border-width:1px;border-style:solid;border-color:black;'><b>Material:</b> ".$_POST['material2']."</div>";
	...
	$Body .= "<div style='display:inline-block;width:48%;min-height:30px;padding:5px;border-width:1px;border-style:solid;border-color:black;'><b>Material:</b> ".$_POST['materialToUse2']."</div>";
...
/*	$Body .= "<div style='display:inline-block;width:48%;min-height:30px;padding:5px;border-width:1px;border-style:solid;border-color:black;'><b>Material:</b> ".$_POST['material3']."</div>";
	...
	$Body .= "<div style='display:inline-block;width:48%;min-height:30px;padding:5px;border-width:1px;border-style:solid;border-color:black;'><b>Material:</b> ".$_POST['materialToUse3']."</div>";
