...
if( isset($_POST['date']) ){
	...
	$p = $conn->prepare("SELECT * FROM projects WHERE template_date > :template_date and template_date < :limitDate");
	$p->bindParam('template_date', $curDate);
                ...
                (function (marker, value) {
                    google.maps.event.addListener(marker, "click", function (e) {
                      ...
                      var html_str = "<div style = 'width:200px;min-height:40px'>";
                          ...
                          html_str +=   "<div>";
                          html_str +=     "<select class='form-control'>";
                          <?php foreach ($rows as $row){ ?>
                          html_str +=       "<option id='contactChoice<?php echo $row['temp_team_id']; ?>' value='<?php echo $row['temp_team_id']; ?>'><?php echo $row['temp_team_name']; ?></option>";
                          <?php } ?>
                          html_str +=     "</select>";
                          html_str +=    "</div>";
                          html_str +=    "<div>";
			...
			?>
				<div class="row team<?php echo $row['temp_team_id']; ?>">
					<div class="col-sm-1 team_no">
						<i class="fa fa-truck" style="color:<?PHP echo $color ?>;"></i></br>
					</div>
					<div class="col-sm-8 team_no">
						<p class="pl-1"><?php echo $row['temp_team_name']; ?></span>
					</div>
					<div class="col-sm-2">
