...
?>
					...
					<div class="col-12 col-md-3">
						<div class="row">
							<div class="hidden" id="accs1"><?= $_SESSION['access_level'] ?></div>
							<div class="col-6">
					...
					<div class="col-12 col-md-3">
						<div class="row">
							...
							<div class="col-6">
								<input class="form-control" name="discount_quartz" id="discount_quartz" type='number'  step='0.01' value='0.00' data-transform="input-control">
								<span id="usernameError"></span>
							</div>
						</div>
					</div>
				...
				<form name="user_billing" id="user_billing1" action="#" class="row pl-3" style="display: none">
					<div class="col-12 ">
						...
						<div class="row ">
							<div class="col-12 ">
								<div style="display:inline-block" class="input-control switch margin10" data-role="input-control">
										...
										<input class="with-gap" style="display:inline-block" id="sameAdd" name="sameAdd" type="checkbox" value="sameAs" data-transform="input-control" data-transform-type="switch" onChange="autoFillBilling()">
									<label style="display:inline-block">Same as User Account?</label>
								</div>
							</div>
						</div>
					</div>
