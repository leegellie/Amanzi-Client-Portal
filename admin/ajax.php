		...
		if ($results['job_status'] != 52) {
			...
			if((time()+(60*60*24*4)) > strtotime($results['install_date']) && ($results['job_status'] < 53 || $results['job_status'] != 59)) {
				echo '<i class="fas fa-clock fa-pulse text-danger"></i>';
					...
					<div class="col-md-5 h5"><div class="btn btn-sm btn-primary">A</div><div class="btn btn-sm btn-primary">A</div><div class="btn btn-sm btn-primary">A</div><div class="btn btn-sm btn-primary">A</div></div>
				</div>
			</div>
		<?
		} else {
