...
// INSTALLS
	...
	echo		'			<div onClick="window.open('.$link.')" class="btn btn-sm text-left '.$temp['button'].'" style="width:100%" role="button" data-placement="top" data-trigger="hover" data-toggle="popover" data-title="<b>'.$t['job_name']."</b> - ".$t['status_name'].'" data-content="Job">';
					if ($t['order_num'] > 0) {
						echo 'O-'.$t['order_num'].' - ';
