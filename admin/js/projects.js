...
// Add comments
	...
	$("#p-install_date").click(function(e) {
		if ( $('#p-job_sqft').val() > 1 || $('#p-order_num').val().indexOf('o') > 0 || $('#p-order_num').val().indexOf('r') > 0 || $('#p-order_num').val().indexOf('O') > 0 || $('#p-order_num').val().indexOf('R') > 0 ) {
