...
if( isset($_POST['teamID']) && isset($_POST['jobID']) && isset($_POST['cur_date'])){
	...
	$q = $conn->prepare("UPDATE projects SET job_status = 13, template_team = :teamID WHERE id = :jobID");
							...
							if (value['job_lat'] != 0 || value['job_lat'] != null) {
								...
								(function (marker, value) {
									...
									var html_str = "<div style = 'width:200px;min-height:40px'>";
										...
										html_str +=   "<br>Templater: <b>" + templaters[tempTeamID] + "</b><br>";
									...
									if (status == 'OK') {
										...
										(function (marker, value) {
											...
											var html_str = "<div style = 'width:200px;min-height:40px'>";
												...
												html_str +=   "<p>Templ. Date: <b class='text-success'>" + value['template_date'] + "</b>";
												if (value['temp_first_stop'] == 1){
													html_str +=   "<p class='text-primary'><b> 1st Stop</b></p>";
												}else if (value['temp_am'] == 1) {
													html_str +=   "<p class='text-primary'><b> AM</b>";
												}else if (value['temp_pm'] == 1) {
													html_str +=   "<p class='text-primary'><b> PM</b>";
												}
												var tempTeamID = value['template_team'];
												html_str +=   "<br>Templater: <b>" + templaters[tempTeamID] + "</b><br>";
												html_str +=   "Account rep: <b>" + value['fname'] + ' ' + value['lname'] + "</b></p>";
					...
					<div class="col-12 pr-4 team_section">
						...
						<div class="row team<?= $row['temp_team_id'] ?>">
							<div class="col-sm-1 team_no">
								...
								?>
								<i class="fas fa-car" style="color:<?PHP echo $color ?>; font-size: 1.6rem"></i><br>
								<?
								}
								?>
							</div>
