						...
						<div class="container pt-3 mb-3">
							<div class="row">
								...
								<fieldset class="form-check col-md-2">
									...
									<input id="p-job_discount text-center" class="form-control" name="job_discount" type="text" value="0">
								</fieldset>
								<fieldset class="form-group col-6 col-md-2">
					...
					<div class="container pt-3  border border-light border-right-0 border-left-0 blue lighten-5">
						<div class="row">
							...
							<fieldset class="form-group col-6 col-lg-3">
								<label for="i-price_calc">Material Cost:</label>
							...
							<fieldset class="form-group col-6 col-lg-3">
								<label for="i-accs_prices">Sinks &amp; Faucets Costs:</label>
								<div class="input-group">
									<div class="input-group-prepend">
										<span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
									</div>
					...
					<form name="user_data" id="user_data" action="#" class="AdvancedForm row">
						...
						<div class="col-12 col-md-6">
							<div class="row p-0">
								...
								<div class="col-7 p-0">
									<input class="form-control" name="discount" id="discount" <? if($_SESSION['access_level'] == 1) { ?> type='number' <? } else { ?> type='hidden' <? } ?> step='0.01' value='0.00' data-transform="input-control">
